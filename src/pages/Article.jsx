    ...
    <section className="page article-page">
      ...
      <article className="article-card">
        ...
        <p>
          ...
          holds a meaning of life. My practice centers on lifting these small
          phenomena out of background noise and presenting them with intention,
          so they can be admired rather than overlooked. In doing so, I hope to
          establish a habit of collective attention that revalues the small,
          subtle moments that actually shape how we experience the world.
        </p>
      </article>
      ...
      <article className="article-card article-summary">
        <div className="article-note">
          ...
          <p>
            ...
            movements, the peak hour of traffic — and use repetition and texture
            to echo those beats in my work. Translating rhythm across mediums
            makes the familiar legible to different audiences: a soundscape can
            reopen a memory for someone who would miss it visually, a painting
            can capture a tempo that text cannot. This translation becomes a
            tool for empathy, being a bridge between personal perception and
